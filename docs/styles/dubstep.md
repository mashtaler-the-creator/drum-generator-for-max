...
9. **`dubstep_crossover_rush_fill`** (fill, 1 bar) — Hamdi-era crossover energy: double-speed hat rush into a rising snare build with tom accents. Ref: Hamdi "Skanka" transitions.
10. **`dubstep_dub_space_fill`** (fill, 1 bar) — dub-wise sparse fill: a decaying rim "delay tail" after the snare plus one low tom pickup; for the meditative material. Ref: DMZ dub-sirens-and-space transitions.
